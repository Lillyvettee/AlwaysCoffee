      ...
      <section className="relative bg-gradient-to-br from-[#ffe5e5] via-[#f5d7d7] to-[#ffd1d1] py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl md:text-6xl mb-6 text-[#c84a4a]" style={{ fontFamily: 'Delius Swash Caps', cursive }}>
      ...
      <section className="py-16 relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-4xl mb-6 text-[#c84a4a]" style={{ fontFamily: "'Dancing Script', cursive" }}>Visit Us Today</h2>
